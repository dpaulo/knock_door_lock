...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, you can say Hello, Unlock the door or Help. Which would you like to try?"
...
class UnlockIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        mqtt_client.unlock_door()
        speak_output = "Door Unlocked"
...
class LockIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        mqtt_client.lock_door()
        speak_output = "Door Locked"
